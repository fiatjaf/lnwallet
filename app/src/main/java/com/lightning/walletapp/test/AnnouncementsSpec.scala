...
class AnnouncementsSpec {
  ...
  def allTests = Future {

    {
      ...
      val node1 = PublicKey(
        ByteVector fromValidHex "027710df7a1d7ad02e3572841a829d141d9f56b17de9ea124d2f83ea687b2e0461"
      )
      val node2 = PublicKey(
        ByteVector fromValidHex "0306a730778d55deec162a74409e006034a24c46d541c67c6c45f89a2adde3d9b4"
      )
      // NB: node1 < node2
...

    {
      ...
      val (node_a, node_b, bitcoin_a, bitcoin_b) =
        (randomKey, randomKey, randomKey, randomKey)
      val (node_a_sig, bitcoin_a_sig) = signChannelAnnouncement(
      ...
      val (node_b_sig, bitcoin_b_sig) = signChannelAnnouncement(
        Block.RegtestGenesisBlock.hash,
        42,
        node_b,
        node_a.publicKey,
      ...
      val ann = makeChannelAnnouncement(
        Block.RegtestGenesisBlock.hash,
        42,
        node_a.publicKey,
        node_b.publicKey,
    ...
    {
      println("check flags")
      val node1_priv = PrivateKey(
        ByteVector fromValidHex "5f447b05d86de82de6b245a65359d22f844ae764e2ae3824ac4ace7d8e1c749b01"
      )
      val node2_priv = PrivateKey(
        ByteVector fromValidHex "eff467c5b601fdcc07315933767013002cd0705223d8e526cbb0c1bc75ccb62901"
      )
      ...
      val channelUpdate1 = makeChannelUpdate(
        Block.RegtestGenesisBlock.hash,
        node1_priv,
        node2_priv.publicKey,
        0,
        0,
        0,
        0,
      ...
      val channelUpdate1_disabled = makeChannelUpdate(
        Block.RegtestGenesisBlock.hash,
        node1_priv,
        node2_priv.publicKey,
        0,
      ...
      val channelUpdate2 = makeChannelUpdate(
        Block.RegtestGenesisBlock.hash,
        node2_priv,
        node1_priv.publicKey,
        0,
        0,
        0,
        0,
      ...
      val channelUpdate2_disabled = makeChannelUpdate(
        Block.RegtestGenesisBlock.hash,
        node2_priv,
        node1_priv.publicKey,
        0,
