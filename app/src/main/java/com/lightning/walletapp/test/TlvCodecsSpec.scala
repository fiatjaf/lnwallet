  ...
  def allTests = {
...

    {
      ...
      val testCases = Seq(
        ...
        (
          ByteVector.fromValidHex("07 01000000000000"),
          UInt64(281474976710656L)
        ),
        (
          ByteVector.fromValidHex("07 01020304050607"),
          UInt64(283686952306183L)
        ),
        (
          ByteVector.fromValidHex("07 ffffffffffffff"),
          UInt64(72057594037927935L)
        ),
        (
          ByteVector.fromValidHex("08 0100000000000000"),
          UInt64(72057594037927936L)
        ),
        (
          ByteVector.fromValidHex("08 0102030405060708"),
          UInt64(72623859790382856L)
        ),
...

    {
      ...
      val testCases = Seq(
        ...
        (
          ByteVector.fromValidHex("21 00"),
          TlvStream[Tlv](Nil, Seq(GenericTlv(33, ByteVector.fromValidHex(""))))
        ),
        (
          ByteVector.fromValidHex("fd0201 00"),
          TlvStream[Tlv](Nil, Seq(GenericTlv(513, ByteVector.fromValidHex(""))))
        ),
        (
          ByteVector.fromValidHex("fd00fd 00"),
          TlvStream[Tlv](Nil, Seq(GenericTlv(253, ByteVector.fromValidHex(""))))
        ),
        (
          ByteVector.fromValidHex("fd00ff 00"),
          TlvStream[Tlv](Nil, Seq(GenericTlv(255, ByteVector.fromValidHex(""))))
        ),
        (
          ByteVector.fromValidHex("fe02000001 00"),
          TlvStream[Tlv](
            Nil,
            Seq(GenericTlv(33554433, ByteVector.fromValidHex("")))
          )
        ),
        (
          ...
          TlvStream[Tlv](
            Nil,
            Seq(GenericTlv(144115188075855873L, ByteVector.fromValidHex("")))
          )
        ),
        (
          ByteVector.fromValidHex("01 00"),
          TlvStream[Tlv](TestType1(0) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex("01 01 01"),
          TlvStream[Tlv](TestType1(1) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex("01 01 2a"),
          TlvStream[Tlv](TestType1(42) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex("01 02 0100"),
          TlvStream[Tlv](TestType1(256) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex("01 03 010000"),
          TlvStream[Tlv](TestType1(65536) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex("01 04 01000000"),
          TlvStream[Tlv](TestType1(16777216) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex("01 05 0100000000"),
          TlvStream[Tlv](TestType1(4294967296L) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex("01 06 010000000000"),
          TlvStream[Tlv](TestType1(1099511627776L) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex("01 07 01000000000000"),
          TlvStream[Tlv](TestType1(281474976710656L) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex("01 08 0100000000000000"),
          TlvStream[Tlv](TestType1(72057594037927936L) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex("02 08 0000000000000226"),
          TlvStream[Tlv](TestType2(550L) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex(
            "03 31 023da092f6980e58d2c037173180e9a465476026ee50f96695963e8efe436f54eb 0000000000000231 0000000000000451"
          ),
          TlvStream[Tlv](
            TestType3(
        ...
        (
          ByteVector.fromValidHex("fd00fe 02 0226"),
          TlvStream[Tlv](TestType254(550) :: Nil, Nil)
        ),
        (
          ByteVector.fromValidHex(
          ...
          TlvStream[Tlv](
            TestType1(561) :: TestType2(1105L) :: TestType3(
              PublicKey.fromValidHex(
        ...
        (
          ByteVector.fromValidHex("01020231 0b020451 fd00fe02002a"),
          TlvStream[Tlv](
            Seq(TestType1(561), TestType254(42)),
            Seq(GenericTlv(11, ByteVector.fromValidHex("0451")))
          )
        )
      )
...

    {
      ...
      val testCases = Seq(
        ...
        ByteVector
          .fromValidHex("01 07 00010000000000"), // not minimally-encoded
        ByteVector
          .fromValidHex("01 08 0001000000000000"), // not minimally-encoded
        // Invalid TestTlv2.
        ...
        // Invalid TestTlv3.
        ByteVector.fromValidHex(
          "03 21 023da092f6980e58d2c037173180e9a465476026ee50f96695963e8efe436f54eb"
        ), // invalid length
        ByteVector.fromValidHex(
          "03 29 023da092f6980e58d2c037173180e9a465476026ee50f96695963e8efe436f54eb0000000000000001"
        ), // invalid length
        ByteVector.fromValidHex(
          "03 30 023da092f6980e58d2c037173180e9a465476026ee50f96695963e8efe436f54eb000000000000000100000000000001"
        ), // invalid length
        ByteVector.fromValidHex(
          "03 32 023da092f6980e58d2c037173180e9a465476026ee50f96695963e8efe436f54eb0000000000000001000000000000000001"
        ), // invalid length
        // Invalid TestTlv254.
        ...
        ByteVector
          .fromValidHex("01012a 02"), // valid tlv record followed by invalid tlv record (length missing)
        ByteVector
          .fromValidHex("01012a 0208"), // valid tlv record followed by invalid tlv record (value missing)
        ByteVector
          .fromValidHex("01012a 020801010101"), // valid tlv record followed by invalid tlv record (value truncated)
        ByteVector
          .fromValidHex("02080000000000000226 01012a"), // valid tlv records but invalid ordering
        ByteVector
          .fromValidHex("1f00 0f012a"), // valid tlv records but invalid ordering
        ByteVector
          .fromValidHex("02080000000000000231 02080000000000000451"), // duplicate tlv type
        ByteVector
          .fromValidHex("01012a 0b020231 0b020451"), // duplicate tlv type
        ByteVector.fromValidHex("1f00 1f012a"), // duplicate tlv type
        ByteVector
          .fromValidHex("01012a 0a020231 0b020451") // valid tlv records but from different namespace
      )
...

    {
      ...
      for (testCase <- testCases) {
        assert(
          lengthPrefixedTestTlvStreamCodec
            .encode(
              lengthPrefixedTestTlvStreamCodec
                .decode(testCase.bits)
                .require
                .value
            )
            .require
...

    {
      ...
      val stream = TlvStream[Tlv](
        Seq(TestType254(42), TestType1(42)),
        Seq(
          GenericTlv(13, ByteVector.fromValidHex("2a")),
          GenericTlv(11, ByteVector.fromValidHex("2b"))
        )
      )
      assert(
        testTlvStreamCodec.encode(stream).require.toByteVector == ByteVector
          .fromValidHex("01012a 0b012b 0d012a fd00fe02002a")
      )
      assert(
        lengthPrefixedTestTlvStreamCodec
          .encode(stream)
          ...
          .fromValidHex("0f 01012a 0b012b 0d012a fd00fe02002a")
      )
    }

    {
      ...
      val testCases = Seq(
        ...
        TlvStream[Tlv](
          Seq(TestType1(561), TestType2(1105L)),
          Seq(GenericTlv(42, ByteVector.fromValidHex("2a")))
        ),
        // Duplicate type.
        TlvStream[Tlv](TestType1(561) :: TestType1(1105) :: Nil, Nil),
        TlvStream[Tlv](
          Seq(TestType1(561)),
          Seq(GenericTlv(1, ByteVector.fromValidHex("0451")))
        )
      )
      ...
      for (stream <- testCases) {
        ...
        assert(
          lengthPrefixedTestTlvStreamCodec.encode(stream).isFailure,
          stream
        )
      }
    }
...
object TlvCodecsSpec {
  ...
  case class TestType3(nodeId: PublicKey, value1: UInt64, value2: UInt64)
      extends Tlv
  case class TestType254(intValue: Int) extends Tlv

  private val testCodec1: Codec[TestType1] = ("value" | tu64).as[TestType1]
  val testCodec2: Codec[TestType2] = (("length" | constant(
    ByteVector.fromValidHex("08")
  )) :: ("short_channel_id" | int64)).as[TestType2]
  val testCodec3: Codec[TestType3] = (("length" | constant(
    ByteVector.fromValidHex("31")
  )) :: ("node_id" | publicKey) :: ("value_1" | uint64) :: ("value_2" | uint64))
    .as[TestType3]
  val testCodec254: Codec[TestType254] =
    (("length" | constant(ByteVector.fromValidHex("02"))) :: ("value" | uint16))
      .as[TestType254]
  private val testTlvCodec = discriminated[Tlv]
    .by(varint)
  ...
  val lengthPrefixedTestTlvStreamCodec =
    variableSizeBytesLong(varintoverflow, tlvStream(testTlvCodec))
  ...
  val otherTlvStreamCodec = tlvStream(
    discriminated[Tlv]
      .by(varint)
