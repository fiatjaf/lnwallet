  ...
  def allTests = {
    {
      ...
      val keys = Seq(
        ...
        ByteVector.fromValidHex(
          "24653eac434488002cc06bbfb7f10fe18991e35f9fe4302dbea6d2353dc0ab1c7f31ebc5462c1fdce1b737ecff52d37d75dea43ce11c74d25aa297165faa2007"
        )
      )
      val messages = Seq(
...

    {
      ...
      val testCases = Seq(
        ...
        (
          ByteVector.fromValidHex(
            "4aa79e2da0cb5beae9b5dad4006909cb402e4201e191733bc2b5279629e4ed80"
          ),
          ByteVector.fromValidHex(
            "fd0001000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f30313233"
          )
        )
