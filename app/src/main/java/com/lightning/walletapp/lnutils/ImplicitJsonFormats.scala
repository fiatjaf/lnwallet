...
object ImplicitJsonFormats extends DefaultJsonProtocol { me =>
  ...
  implicit object PublicKeyFmt extends JsonFormat[PublicKey] {
    def read(json: JsValue): PublicKey =
      PublicKey.fromValidHex(me json2String json)
  ...
  implicit val lastCrossSignedStateFmt = sCodecJsonFmt(
  ...
  implicit val blindParamFmt =
    jsonFormat[
      ...
      BigInteger,
      BlindParam
    ](BlindParam.apply, "point", "a", "b", "c", "bInv")

  implicit val blindMemoFmt =
    jsonFormat[List[BlindParam], List[BigInteger], String, BlindMemo](
      BlindMemo.apply,
      "params",
      "clears",
      "key"
  ...
  implicit val privateKeyFmt = jsonFormat[Scalar, Boolean, PrivateKey](
    PrivateKey.apply,
    "value",
    "compressed"
  )
  implicit val milliSatoshiFmt =
    jsonFormat[Long, MilliSatoshi](MilliSatoshi.apply, "amount")
  ...
  implicit val messageActionFmt = taggedJsonFmt(
  ...
  implicit val urlActionFmt = taggedJsonFmt(
  ...
  implicit val aesActionFmt = taggedJsonFmt(
  ...
  implicit val paymentDescriptionFmt =
    jsonFormat[Option[PaymentAction], String, PaymentDescription](
    ...
    def read(serialized: JsValue): LNUrlData =
      serialized.asJsObject fields TAG match {
        ...
        case JsString("channelRequest") =>
          serialized.convertTo[IncomingChannelRequest]
  ...
  implicit val incomingChannelRequestFmt = taggedJsonFmt(
    jsonFormat[String, String, String, IncomingChannelRequest](
      IncomingChannelRequest.apply,
      "uri",
      "callback",
      "k1"
    ),
  ...
  implicit val hostedChannelRequestFmt = taggedJsonFmt(
  ...
  implicit val withdrawRequestFmt = taggedJsonFmt(
    jsonFormat[String, String, Long, String, Option[Long], WithdrawRequest](
  ...
  implicit val payRequestFmt = taggedJsonFmt(
    jsonFormat[String, Long, Long, String, PayRequest](
      PayRequest.apply,
      "callback",
      "maxSendable",
      "minSendable",
  ...
  implicit val payRequestFinalFmt =
    jsonFormat[Vector[PayRequest.Route], String, PaymentAction, PayRequestFinal](
  ...
  implicit val outPointFmt =
    jsonFormat[ByteVector, Long, OutPoint](OutPoint.apply, "hash", "index")
  implicit val txOutFmt = jsonFormat[Satoshi, ByteVector, TxOut](
    TxOut.apply,
    "amount",
    "publicKeyScript"
  )
  implicit val inputInfoFmt =
    jsonFormat[OutPoint, TxOut, ByteVector, InputInfo](
      InputInfo.apply,
      "outPoint",
      "txOut",
      "redeemScript"
  ...
  implicit object TransactionWithInputInfoFmt
    ...
    def read(json: JsValue) = json.asJsObject fields TAG match {
      ...
      case JsString("ClaimP2WPKHOutputTx") =>
        json.convertTo[ClaimP2WPKHOutputTx]
      case JsString("ClaimDelayedOutputTx") =>
        json.convertTo[ClaimDelayedOutputTx]
      case JsString("ClaimDelayedOutputPenaltyTx") =>
        json.convertTo[ClaimDelayedOutputPenaltyTx]
    ...
    def write(internal: TransactionWithInputInfo) = internal match {
      ...
      case transactionWithInputInfo: HtlcSuccessTx =>
        transactionWithInputInfo.toJson
      case transactionWithInputInfo: HtlcTimeoutTx =>
        transactionWithInputInfo.toJson
      case transactionWithInputInfo: ClaimHtlcSuccessTx =>
        transactionWithInputInfo.toJson
      case transactionWithInputInfo: ClaimHtlcTimeoutTx =>
        transactionWithInputInfo.toJson
      case transactionWithInputInfo: ClaimP2WPKHOutputTx =>
        transactionWithInputInfo.toJson
      case transactionWithInputInfo: ClaimDelayedOutputTx =>
        transactionWithInputInfo.toJson
      case transactionWithInputInfo: ClaimDelayedOutputPenaltyTx =>
        transactionWithInputInfo.toJson
      case transactionWithInputInfo: MainPenaltyTx =>
        transactionWithInputInfo.toJson
      case transactionWithInputInfo: HtlcPenaltyTx =>
        transactionWithInputInfo.toJson
      case transactionWithInputInfo: ClosingTx =>
        transactionWithInputInfo.toJson
    }
  }

  implicit val commitTxFmt = taggedJsonFmt(
    jsonFormat[InputInfo, Transaction, CommitTx](CommitTx.apply, "input", "tx"),
    tag = "CommitTx"
  )

  implicit val htlcSuccessTxFmt = taggedJsonFmt(
    jsonFormat[InputInfo, Transaction, UpdateAddHtlc, HtlcSuccessTx](
      HtlcSuccessTx.apply,
      "input",
      "tx",
      "add"
  ...
  implicit val htlcTimeoutTxFmt = taggedJsonFmt(
    jsonFormat[InputInfo, Transaction, UpdateAddHtlc, HtlcTimeoutTx](
      HtlcTimeoutTx.apply,
      "input",
      "tx",
      "add"
  ...
  implicit val claimHtlcSuccessTxFmt = taggedJsonFmt(
    jsonFormat[InputInfo, Transaction, ClaimHtlcSuccessTx](
      ClaimHtlcSuccessTx.apply,
      "input",
      "tx"
    ),
    tag = "ClaimHtlcSuccessTx"
  )

  implicit val claimHtlcTimeoutTxFmt = taggedJsonFmt(
    jsonFormat[
      Option[UpdateAddHtlc],
      InputInfo,
      Transaction,
      ClaimHtlcTimeoutTx
    ](ClaimHtlcTimeoutTx.apply, "addOpt", "input", "tx"),
    tag = "ClaimHtlcTimeoutTx"
  )

  implicit val claimP2WPKHOutputTxFmt = taggedJsonFmt(
    jsonFormat[InputInfo, Transaction, ClaimP2WPKHOutputTx](
      ClaimP2WPKHOutputTx.apply,
      "input",
      "tx"
    ),
    tag = "ClaimP2WPKHOutputTx"
  )

  implicit val claimDelayedOutputTxFmt = taggedJsonFmt(
    jsonFormat[InputInfo, Transaction, ClaimDelayedOutputTx](
      ClaimDelayedOutputTx.apply,
      "input",
      "tx"
    ),
    tag = "ClaimDelayedOutputTx"
  )

  implicit val mainPenaltyTxFmt = taggedJsonFmt(
    jsonFormat[InputInfo, Transaction, MainPenaltyTx](
      MainPenaltyTx.apply,
      "input",
      "tx"
    ),
  ...
  implicit val htlcPenaltyTxFmt = taggedJsonFmt(
    jsonFormat[InputInfo, Transaction, HtlcPenaltyTx](
      HtlcPenaltyTx.apply,
      "input",
      "tx"
    ),
  ...
  implicit val claimDelayedOutputPenaltyTxFmt = taggedJsonFmt(
    jsonFormat[InputInfo, Transaction, ClaimDelayedOutputPenaltyTx](
      ClaimDelayedOutputPenaltyTx.apply,
      "input",
      "tx"
    ),
    tag = "ClaimDelayedOutputPenaltyTx"
  )

  implicit val closingTxFmt = taggedJsonFmt(
    jsonFormat[InputInfo, Transaction, ClosingTx](
      ClosingTx.apply,
      "input",
      "tx"
    ),
  ...
  implicit val htlcFmt =
    jsonFormat[Boolean, UpdateAddHtlc, Htlc](Htlc.apply, "incoming", "add")
  implicit val commitmentSpecFmt = jsonFormat[Long, Long, Long, Set[Htlc], Set[
    HtlcAndFulfill
  ], Set[HtlcAndFail], Set[Htlc], CommitmentSpec](
    CommitmentSpec.apply,
    "feeratePerKw",
    "toLocalMsat",
    "toRemoteMsat",
    "htlcs",
  ...
  implicit val htlcTxAndSigs =
    jsonFormat[TransactionWithInputInfo, ByteVector, ByteVector, HtlcTxAndSigs](
      HtlcTxAndSigs.apply,
      "txinfo",
      "localSig",
      "remoteSig"
  ...
  implicit val localCommitFmt =
    jsonFormat[Long, CommitmentSpec, Seq[HtlcTxAndSigs], CommitTx, LocalCommit](
      LocalCommit.apply,
      "index",
      "spec",
      "htlcTxsAndSigs",
  ...
  implicit val remoteCommitFmt =
    jsonFormat[Long, CommitmentSpec, Option[Transaction], Point, RemoteCommit](
      RemoteCommit.apply,
      "index",
      "spec",
      "txOpt",
  ...
  implicit val waitingForRevocationFmt =
    jsonFormat[RemoteCommit, CommitSig, Long, WaitingForRevocation](
      WaitingForRevocation.apply,
      "nextRemoteCommit",
      "sent",
  ...
  implicit val changesFmt =
    jsonFormat[LNMessageVector, LNMessageVector, LNMessageVector, Changes](
      Changes.apply,
      "proposed",
      "signed",
      "acked"
  ...
  implicit val hostedCommitsFmt = jsonFormat[
    NodeAnnouncement,
    LastCrossSignedState,
    Vector[LNDirectionalMessage],
    CommitmentSpec,
  ...
  implicit val normalCommitsFmt = jsonFormat[
    LocalParams,
    AcceptChannel,
    LocalCommit,
    RemoteCommit,
    ...
    Long,
    Long,
    Either[WaitingForRevocation, Point],
    InputInfo,
    ShaHashesWithIndex,
    ByteVector,
    Option[ChannelUpdate],
  ...
  implicit val localCommitPublishedFmt =
    jsonFormat[Seq[ClaimDelayedOutputTx], Seq[SuccessAndClaim], Seq[
      TimeoutAndClaim
    ], Transaction, LocalCommitPublished](
      LocalCommitPublished.apply,
      "claimMainDelayed",
      "claimHtlcSuccess",
      "claimHtlcTimeout",
      "commitTx"
  ...
  implicit val remoteCommitPublishedFmt =
    jsonFormat[Seq[ClaimP2WPKHOutputTx], Seq[ClaimHtlcSuccessTx], Seq[
      ClaimHtlcTimeoutTx
    ], Transaction, RemoteCommitPublished](
      RemoteCommitPublished.apply,
      "claimMain",
      "claimHtlcSuccess",
      "claimHtlcTimeout",
      "commitTx"
  ...
  implicit val revokedCommitPublishedFmt =
    jsonFormat[Seq[ClaimP2WPKHOutputTx], Seq[MainPenaltyTx], Seq[HtlcPenaltyTx], Transaction, RevokedCommitPublished](
      RevokedCommitPublished.apply,
      "claimMain",
      "claimTheirMainPenalty",
      "htlcPenalty",
      "commitTx"
    )
  ...
  implicit object HasNormalCommitsFmt extends JsonFormat[HasNormalCommits] {
    def read(json: JsValue) = json.asJsObject fields TAG match {
      case JsString("WaitBroadcastRemoteData") =>
        json.convertTo[WaitBroadcastRemoteData]
      case JsString("WaitFundingDoneData") =>
        json.convertTo[WaitFundingDoneData]
  ...
  implicit val closingTxProposedFmt =
    jsonFormat[ClosingTx, ClosingSigned, ClosingTxProposed](
      ClosingTxProposed.apply,
      "unsignedTx",
      "localClosingSigned"
    )

  implicit val refundingDataFmt = taggedJsonFmt(
    jsonFormat[NodeAnnouncement, Option[Point], NormalCommits, RefundingData](
      RefundingData.apply,
      "announce",
      "remoteLatestPoint",
      "commitments"
  ...
  implicit val closingDataFmt = taggedJsonFmt(
    jsonFormat[
      NodeAnnouncement,
      NormalCommits,
      Seq[ClosingTxProposed],
      Seq[Transaction],
      Seq[LocalCommitPublished],
      Seq[RemoteCommitPublished],
      Seq[RemoteCommitPublished],
      Seq[RemoteCommitPublished],
      Seq[RevokedCommitPublished],
      Long,
      ClosingData
    ](
      ClosingData.apply,
  ...
  implicit val negotiationsDataFmt =
    taggedJsonFmt(
      jsonFormat[NodeAnnouncement, NormalCommits, Shutdown, Shutdown, Seq[
        ClosingTxProposed
      ], Option[ClosingTx], NegotiationsData](
        NegotiationsData.apply,
        "announce",
        "commitments",
        "localShutdown",
        "remoteShutdown",
  ...
  implicit val normalDataFmt =
    taggedJsonFmt(
      jsonFormat[NodeAnnouncement, NormalCommits, Option[Transaction], Option[
        Shutdown
      ], Option[Shutdown], NormalData](
        NormalData.apply,
        "announce",
        "commitments",
        "unknownSpend",
  ...
  implicit val waitFundingDoneDataFmt =
    taggedJsonFmt(
      jsonFormat[
        NodeAnnouncement,
        Option[FundingLocked],
        Option[FundingLocked],
        Transaction,
        NormalCommits,
        WaitFundingDoneData
      ](
        WaitFundingDoneData.apply,
        "announce",
        "our",
        "their",
        "fundingTx",
  ...
  implicit val waitFundingSignedCoreFmt =
    jsonFormat[LocalParams, ByteVector, Option[ChannelFlags], AcceptChannel, CommitmentSpec, RemoteCommit, WaitFundingSignedCore](
      WaitFundingSignedCore.apply,
      "localParams",
      "channelId",
      "channelFlags",
      "remoteParams",
  ...
  implicit val waitBroadcastRemoteDataFmt =
    taggedJsonFmt(
      jsonFormat[NodeAnnouncement, WaitFundingSignedCore, NormalCommits, Option[
        FundingLocked
      ], Option[String], WaitBroadcastRemoteData](
        WaitBroadcastRemoteData.apply,
        "announce",
        "core",
        "commitments",
        "their",
  ...
  implicit val outRequestFmt =
    jsonFormat[Long, Set[String], Set[Long], Set[String], String, OutRequest](
      OutRequest.apply,
      "sat",
      "badNodes",
      "badChans",
  ...
  implicit object TagFmt extends JsonFormat[Tag] {
    def read(json: JsValue): Tag =
      PaymentRequest.Tag parse json.convertTo[Bytes]
    def write(internal: Tag): JsValue = internal.toInt5s.toJson
  }

  implicit val paymentRequestFmt =
    jsonFormat[String, Option[MilliSatoshi], Long, PublicKey, Vector[Tag], ByteVector, PaymentRequest](
  ...
  implicit object CloudActFmt extends JsonFormat[CloudAct] {
    ...
    def read(serialized: JsValue): CloudAct =
      serialized.asJsObject.fields get TAG match {
        case Some(s: JsString) if s.value == "ChannelUploadAct" =>
          serialized.convertTo[ChannelUploadAct]
        case Some(s: JsString) if s.value == "TxUploadAct" =>
          serialized.convertTo[TxUploadAct]
        case Some(s: JsString) if s.value == "CerberusAct" =>
          serialized.convertTo[CerberusAct]
        case _ => serialized.convertTo[LegacyAct]
      }
  }

  implicit val legacyActFmt =
    jsonFormat[ByteVector, Seq[HttpParam], String, LegacyAct](
      LegacyAct.apply,
      "data",
      "plus",
      "path"
  ...
  implicit val cerberusActFmt = taggedJsonFmt(
    jsonFormat[ByteVector, Seq[HttpParam], String, StringVec, CerberusAct](
      CerberusAct.apply,
      "data",
      "plus",
      "path",
  ...
  implicit val txUploadActFmt = taggedJsonFmt(
    jsonFormat[ByteVector, Seq[HttpParam], String, TxUploadAct](
      TxUploadAct.apply,
      "data",
      "plus",
      "path"
  ...
  implicit val channelUploadActFmt = taggedJsonFmt(
    jsonFormat[ByteVector, Seq[HttpParam], String, String, ChannelUploadAct](
      ChannelUploadAct.apply,
      "data",
      "plus",
      "path",
      "alias"
    ),
    tag = "ChannelUploadAct"
  )

  implicit val ratesFmt =
    jsonFormat[Seq[Double], Seq[Double], Fiat2Btc, Long, Rates](
      Rates.apply,
      "feesSix",
      "feesThree",
      "exchange",
  ...
  implicit val cloudDataFmt = jsonFormat[Option[RequestAndMemo], Vector[
    ClearToken
  ], Vector[CloudAct], CloudData](CloudData.apply, "info", "tokens", "acts")
  implicit val localBackupsFmt = jsonFormat[Vector[HasNormalCommits], Vector[
    HostedCommits
  ], Long, Int, LocalBackups](
    LocalBackups.apply,
    "normal",
    "hosted",
    "earliestUtxoSeconds",
  ...
  implicit val topNodesFmt =
    jsonFormat[StringVec, Long, TopNodes](TopNodes.apply, "nodes", "stamp")
}
